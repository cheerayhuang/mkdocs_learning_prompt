...
## 关于作者
本教程作者是 thinkingjimmy 。原项目部署在 github pages 上，为了便于在行内部署，使用了 [mkdocs](https://www.mkdocs.org/) 对项目结构和文件进行了部分重构。
...
1. [ChatGPT 教程](chatgpt-learning-path.md)：由浅入深，从使用者的角度，教你如何使用 ChatGPT，以及如何更好地使用 ChatGPT。
2. [Midjourney 教程](midjourney-learning-path.md)：通过各种场景案例，教你如何使用 Midjourney。即使是小白，看完教程后，也能够快速上手。
